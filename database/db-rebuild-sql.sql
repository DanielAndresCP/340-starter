...
-- Table structure or table 'acount'
...
-- Table structure for the comments, this is from the final project enhancement
CREATE TABLE public.comment (
	comment_id INT GENERATED BY DEFAULT AS IDENTITY,
	comment_text CHARACTER VARYING NOT NULL,
	comment_date character(10)  NOT NULL, -- will just use yyyy/mm/dd
...
-- Create relationship between 'comment' and 'account' tables
...
-- Create relationship between 'comment' and 'inventory' tables
ALTER TABLE IF EXISTS public.comment
